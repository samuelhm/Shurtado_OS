...
-   [Prev](licenses.md "LFS Licenses"){accesskey="p"}
...
-   [Up](licenses.md "Appendix D. LFS Licenses"){accesskey="u"}

-   [Home](../index.md "Linux From Scratch - Version r13.0-131-systemd"){accesskey="h"}
:::

# []{#CC}D.1. Creative Commons License {#d.1.-creative-commons-license .sect1}
