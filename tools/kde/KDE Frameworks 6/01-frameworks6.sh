...
step "Building KDE Frameworks ${VERSION} (all packages)..."
while read -r line; do
    ...
    pushd $packagedir
      ...
      cmake -D CMAKE_INSTALL_PREFIX=$KF6_PREFIX \
            ...
            -W no-dev .. || err "cmake failed for $name"
      make || err "make failed for $name"
...
echo ""
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}  KDE Frameworks ${VERSION} - Instalacion completada${NC}"
echo -e "${GREEN}========================================${NC}"
echo ""
