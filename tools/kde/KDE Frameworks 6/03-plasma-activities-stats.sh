...
SOURCES="/sources"
PKG="plasma-activities-stats-6.6.5"
TAR="$PKG.tar.xz"
...
echo -e "${GREEN}========================================${NC}"
echo ""
echo -e "  Libreria:   ${GREEN}libPlasmaActivitiesStats.so${NC}"
echo -e "  Ubicacion:  ${BLUE}$KF6_PREFIX${NC}"
echo ""
echo -e "  Proposito: Acceso a datos de uso del sistema de Actividades."
echo -e "  Requerido por kio-extras."
echo ""
