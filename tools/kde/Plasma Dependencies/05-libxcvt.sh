...
echo -e "${GREEN}========================================${NC}"
echo ""
echo -e "  Libreria:   ${GREEN}libxcvt.so${NC}"
echo -e "  Programa:   ${GREEN}cvt${NC}"
echo -e "  Ubicacion:  ${BLUE}$XORG_PREFIX/lib${NC}"
echo ""
echo -e "  Proposito: Generador de modelines VESA CVT timing."
echo -e "  Reemplazo standalone del modulo del servidor X."
echo ""
