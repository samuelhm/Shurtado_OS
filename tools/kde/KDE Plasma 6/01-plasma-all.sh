...
step "Building KDE Plasma ${VERSION} (all packages)..."
while read -r line; do
    ...
    pushd $packagedir
       ...
       cmake -D CMAKE_INSTALL_PREFIX=$KF6_PREFIX \
             ...
             -D BUILD_QT5=OFF                    \
             -D BUILD_TESTING=OFF                \
             -W no-dev .. || err "cmake failed for $packagedir"
       make || err "make failed for $packagedir"
...
echo ""
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}  KDE Plasma ${VERSION} - Instalacion completada${NC}"
echo -e "${GREEN}========================================${NC}"
echo ""
