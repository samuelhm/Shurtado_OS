...
step "Downloading libva 2.23.0 (stub: sin EGL/GLX)..."
cd "$SOURCES"
[ -f "$TAR" ] || wget "$URL"
...
step "Building libva (stub - sin Mesa)..."
...
echo ""
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}  libva 2.23.0 (stub) - Instalacion completada${NC}"
echo -e "${GREEN}========================================${NC}"
echo ""
echo -e "  Librerias:  ${GREEN}libva.so, libva-drm.so${NC}"
echo -e "  Ubicacion:  ${BLUE}$XORG_PREFIX/lib/${NC}"
echo ""
echo -e "  Proposito: API de aceleracion de video por hardware (stub)."
echo -e "  Se reconstruira con soporte EGL/GLX tras instalar Mesa."
echo ""
